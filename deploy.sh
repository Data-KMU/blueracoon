...
ssh taaja@taaja.io 'docker load --quiet --input /home/taaja/taaja-blueracoon.tar  && rm -f /home/taaja/taaja-blueracoon.tar && cd /home/taaja/deployment/taaja && docker-compose up -d'